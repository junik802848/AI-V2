module.exports = async function handler(req, res) {
  ...
  try {
    const r = await fetch(`${base}/rest/v1/tbm_files?select=public_url,file_name,created_at&page=eq.tbm40&mime_type=like.image%2F*&order=created_at.desc&limit=1`, { headers: { Authorization: `Bearer ${key}`, apikey: key } });
